<script setup>
import IconCamera from '@/components/meeting/meeting-room/icons/IconCamera.vue';
            ...
            <div class="action-bar">
                <div style="position: relative;">
                    ...
                    <div class="dropdown-card" ref="dropdown" :class="{ show: isShow }" id="dropdown-card">
                        ...
                        <div @click="createMeeting"
                            class="option-item d-flex align-items-center justify-content-center text-center">
                            <div class="option-text">
                ...
                <div class="join-input-wrapper">
                    ...
                    <input v-model="link" type="text" class="join-input" placeholder="Nhập mã hoặc đường liên kết"
                        id="join-code">
